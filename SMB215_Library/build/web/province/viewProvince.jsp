	...
	<div class="main">
        ...
        <section id="content"><div class="ic"><div class="inner_copy">All <a href="http://www.magentothemesworld.com" title="Best Magento Templates">premium Magento themes</a> at magentothemesworld.com!</div></div>
            <div class="container_12">
				...
				<a href="editCity.jsp"><input type="submit" name="Submit" value="Add" class="button"/></a>
				</div>
				       ...
				       <tr>
					    ...
					    <td width="10%">Actions</td>
                                       ...
                                       <%
                                            ...
                                            List<City> list = citBean.getCities();
                                            for (City cit : list) {
                                        %>
				       <tr>
                                           <td><%=String.valueOf(cit.getShortName())%></td>
                                           <td><%=cit.getName()%></td>
                                           <td>
                                                <a href="editCity.jsp?id=<%=String.valueOf(cit.getId())%>" class="fa fa-lg fa-pencil-square-o"></a>
                                                <a href="../DeleteCity?id=<%=String.valueOf(cit.getId())%>" class="fa fa-lg fa-trash-o"></a> 
                                            </td>
				       </tr>
				      <%
                                            }
