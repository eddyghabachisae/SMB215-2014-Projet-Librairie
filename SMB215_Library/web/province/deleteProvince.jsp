                    ...
                    <div class="wrapper">
                        <article class="grid_8">
                            <div class="indent-right">
                                <h3 class="prev-indent-bot">Delete <%=request.getParameter("pvc1_name")%> Province from Library database</h3>

                                <div id="content3"> 
                                        <form id="form" name="form" action="../deleteProvince" method="post" OnSubmit="return fncSubmit();" >                    
                                        <fieldset>
                                            ...
                                            <div class="wrapper">
                                                <div class="extra-wrap">		
                                                    <div class="buttons">
                                                        <input type="hidden" name="pvc1_id" value="<%=request.getParameter("pvc1_id")%>" />
